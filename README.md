...
Paul Rüsing — [pr@paulruesing.de](mailto:pr@paulruesing.de)  
Paul Busch — [paul.busch@isea.rwth-aachen.de](mailto:paul.busch@isea.rwth-aachen.de)  
Developed in collaboration with an external energy industry partner and RWTH Aachen University (ISEA).
